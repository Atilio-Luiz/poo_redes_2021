...
- Cadastrar funcionário pelo nome.
    - nome do funcionário é único
    - funcionário pode ser professor, servidor técnico administrativo ou terceirizado
- Mostrar funcionário
- Remover funcionário
...
- O salário de professor deve ser calculado com base na sua classe
    ...
    - D 9000
    - E 11000
- O Sta(Servidor Técnico Administrativo) tem um salário base de 3000 e é acrescentado mais 300 de acordo com seu nível
    - salário = 3000 + 300 * nivel
- O salário do Ter(Terceirizado) é obtido do produto das horas trabalhadas e 4
    e é acrescentado 500 se for insalubre
    - salário = 4 * horas (+ 500 se insalubre)

## Regras de negócio parte 2

- Adicionar diárias
- Professores podem receber no máximo 2 diárias, Sta no máximo 1 e Ter não podem receber
- Diárias aumentam 100 reais no salário
